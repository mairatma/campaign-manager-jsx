...
function elementCloseCall(t, path, plugin) {
  var node = path.node;
  ...
  return (0, _toFunctionCall2.default)(t, (0, _idomMethod2.default)("elementClose", plugin), [(0, _toReference2.default)(t, name.node, useReference)]);
}