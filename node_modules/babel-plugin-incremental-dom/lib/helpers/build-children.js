...
function buildChildren(t, children, plugin) {
  ...
  children = children.reduce(function (children, child) {
    ...
    if (child.isJSXText() || (0, _isLiteralOrUndefined2.default)(child)) {
      ...
      if (type === "string" || type === "number") {
        node = (0, _toFunctionCall2.default)(t, (0, _idomMethod2.default)("text", plugin), [t.stringLiteral("" + value)]);
      } else {
        return children;
      }
      ...
      renderArbitraryRef = renderArbitraryRef || (0, _renderArbitrary2.default)(t, plugin);

      node = (0, _toFunctionCall2.default)(t, renderArbitraryRef, [node]);
    }
