...
function elementOpenCall(t, path, plugin) {
  var name = path.get("name");
  var useReference = (0, _isComponent2.default)(name, plugin);
  var tag = (0, _toReference2.default)(t, name.node, useReference);
  var args = [tag];

  var _extractOpenArguments = (0, _extractOpenArguments3.default)(t, path, plugin);
  ...
  if ((0, _attributes.hasSpread)(path.get("attributes"))) {
    var expressions = [(0, _toFunctionCall2.default)(t, (0, _idomMethod2.default)("elementOpenStart", plugin), args)].concat(_toConsumableArray((0, _attributes.toAttrsCalls)(t, attrs, plugin)), [(0, _toFunctionCall2.default)(t, (0, _idomMethod2.default)("elementOpenEnd", plugin), [tag])]);
