...
function toAttrsCalls(t, attrs, plugin) {
  var attrCall = (0, _idomMethod2.default)("attr", plugin);
  var forOwn = (0, _forOwn2.default)(t, plugin);
  var forOwnAttr = (0, _attr2.default)(t, plugin);
  ...
  return attrs.map(function (_ref2) {
    ...
    if (isSpread) {
      return (0, _toFunctionCall2.default)(t, forOwn, [value, forOwnAttr]);
    }

    return (0, _toFunctionCall2.default)(t, attrCall, [name, value]);
  });
}